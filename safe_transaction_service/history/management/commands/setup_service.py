...
class Command(BaseCommand):
    ...
    def setup_my_network(self):
        SafeMasterCopy.objects.get_or_create(address='0xe46349A712652F2d316e469a2cF9B0a6Ad534842',
                                             defaults={
                                                 'initial_block_number': 7797920,
                                                 'tx_block_number': 7797920,
                                             })
        ProxyFactory.objects.get_or_create(address='0xDc6003BA7509C25c0d4e43E036A9baA230c900De',
                                           defaults={
                                               'initial_block_number': 7797925,
                                               'tx_block_number': 7797925,
                                           })
